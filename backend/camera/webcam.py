"""
Generic webcam backend using OpenCV or GStreamer v4l2src.

This is a stub implementation for future USB webcam support.
"""
...
class WebcamCameraBackend(CameraBackend):
    """Camera backend for generic USB webcams."""

    def __init__(self):
        """Initialize the webcam backend."""
        self.platform_name = "webcam"
        raise NotImplementedError(
            "Webcam backend not yet implemented. "
            "This will use OpenCV or GStreamer v4l2src for USB camera access."
        )
